...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("https://daddyleagues.com/GridironLegends/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    postMessage("https://daddyleagues.com/GridironLegends/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("https://daddyleagues.com/GridironLegends/players?name="+rep+"&position=all&team=all");
